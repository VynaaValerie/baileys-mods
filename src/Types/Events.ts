...
export type VynaaEvent = keyof VynaaEventMap

export interface VynaaEventEmitter {
	on<T extends keyof VynaaEventMap>(event: T, listener: (arg: VynaaEventMap[T]) => void): void
	off<T extends keyof VynaaEventMap>(event: T, listener: (arg: VynaaEventMap[T]) => void): void
	removeAllListeners<T extends keyof VynaaEventMap>(event: T): void
	emit<T extends keyof VynaaEventMap>(event: T, arg: VynaaEventMap[T]): boolean
}
