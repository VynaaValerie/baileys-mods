...
export type SocketConfig = {
        ...
        /** should VynaaValerie use the mobile api instead of the multi device api
        ...
        /** Should VynaaValerie ask the phone for full history, will be received async */
        syncFullHistory: boolean
        /** Should VynaaValerie fire init queries automatically, default true */
