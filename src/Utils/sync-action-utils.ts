...
import type { VynaaEventEmitter, VynaaEventMap, Contact } from '../Types'
...
export type LidMappingUpdateResult = {
	...
	data: VynaaEventMap['lid-mapping.update']
}
...
export const emitSyncActionResults = (ev: VynaaEventEmitter, results: SyncActionResult[]): void => {
